...
abstract class AnalyzeUrlBase {
  ...
  AnalyzeUrlBase(this.mUrl, {this.key, this.page, this.speakText, this.speakSpeed, this.voiceName, this.baseUrl, this.analyzer, this.source, Map<String, dynamic>? initialHeaders}) {
