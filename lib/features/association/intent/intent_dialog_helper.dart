...
/// IntentHandlerService 的對話框與 UI 邏輯擴展
mixin IntentDialogHelper on IntentBase {
  ...
  Future<void> _importTts(BuildContext context, String jsonStr) async {
    try {
      ...
      for (var item in list) {
        await dao.insertOrUpdate(HttpTTS.fromJson(item as Map<String, dynamic>));
      }
...
// AI_PORT: GAP-INTENT-01 extracted from IntentHandlerService
