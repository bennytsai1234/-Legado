...
class BookDetailPage extends StatelessWidget {
  ...
  void _showChangeSourceDialog(BuildContext context, BookDetailProvider p) => showModalBottomSheet(context: context, builder: (ctx) => const Padding(padding: EdgeInsets.all(16), child: Column(mainAxisSize: MainAxisSize.min, children: [Text('搜尋書源...'), SizedBox(height: 20), CircularProgressIndicator()])));
